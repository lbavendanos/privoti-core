...
final class CustomerAddressCollection extends ResourceCollection
{
    /**
    ...
    {
        return [
            'data' => $this->collection->map(fn ($address): CustomerAddressResource => new CustomerAddressResource($address)),
        ];
    }
